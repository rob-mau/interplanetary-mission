% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
function [dati] = Cattura(S, t, quota, v_s_i)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%{
  questa funzione gestisce la manovra di cattura

  S         - struct del pianeta
  t         - tempo di inizio cattura (in giorni)
...
figure('Name', 'Manovra di Cattura - Sistema di Riferimento del Pianeta', 'NumberTitle', 'off', 'Color', 'k')
...
angolo = (gamma - phi) * 180/pi; % angolo di inclinazione asse focale iperbole
